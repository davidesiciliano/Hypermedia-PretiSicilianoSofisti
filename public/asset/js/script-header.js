function loadHeader() {
  ...
  const currentPage = header.id.replace("Page", "");
  header.innerHTML = `
    <div class="logo">
      <a href="../../index.html">
    ...
    <ul class="nav-links">
      ...
      <li class="FAQLink selected"><a href="../../pages/FAQ_page.html">FAQ</a></li>
      <li class="TermsLink"><a href="../../pages/terms_page.html">Terms</a></li>
    </ul>
    <div class="burger">
      <div class="line1"></div>
      <div class="line2"></div>
